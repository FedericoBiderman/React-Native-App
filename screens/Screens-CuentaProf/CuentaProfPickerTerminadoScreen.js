...
const CuentaProfPickerTerminadoScreen = () => {
  ...
  const handleVistaPreviaPicker = () => {
    navigation.navigate('ProfilePreviewPickerScreen');
  };
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        ...
        <View style={styles.content}>
          ...
          <TouchableOpacity style={styles.button} onPress={handleVistaPreviaPicker}>
            <Text style={styles.buttonText}>Vista Previa Picker</Text>
          </TouchableOpacity>
